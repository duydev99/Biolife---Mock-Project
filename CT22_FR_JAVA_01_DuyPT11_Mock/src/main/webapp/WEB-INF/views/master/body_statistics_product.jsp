				...
				<div class="card-header pb-0" id="showChangeTime">
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5"
							...
							<li><a class="dropdown-item border-radius-md"
								href="${path}/statistics/products?id=${productId}&key=year&value1=-1&value2=-1">Năm</a></li>
							<li><a class="dropdown-item border-radius-md"
								href="${path}/statistics/products?id=${productId}&key=quarter&value1=-1&value2=-1">Quý</a></li>
							<li><a class="dropdown-item border-radius-md"
								href="${path}/statistics/products?id=${productId}&key=month&value1=-1&value2=-1">Tháng</a></li>
						</ul>
					</div>
				</div>
								...
								<c:forEach var="item" items="${list}" varStatus="myIndex">
									<tr>
										<td class="text-center"><a
											href="${path}/statistics/products?id=${productId}&key=${key}&value1=${item.time}&value2=${value2}">
