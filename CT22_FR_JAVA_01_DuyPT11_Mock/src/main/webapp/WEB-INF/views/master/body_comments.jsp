							...
							<thead>
								<tr>
									...
									<th
										...
										phẩm</th>
									<th
										class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nội
										dung</th>
									<th
							...
							<tbody>
								<c:forEach var="item" items="${list}">
									<tr>
										...
										<a href="${path}/comments/edit?id=${item.id}"
											class="text-info font-weight-bold text-xs"
											data-toggle="tooltip" data-original-title="Edit user">
												<img alt="Cập nhật" src="../images/icon/icon-edit.png" width="25px" height="25px"> </a>|<a href="${path}/comments/delete?id=${item.id}"
