			...
			<div class="card mb-4">
				<div class="card-header pb-0">
					...
					<a href="${path}/manufacturers/add" class="text-success font-weight-bold text-xs"
						...
						<img alt="Thêm mới" src="../images/icon/icon-add.png" width="25px" height="25px"></a>
				</div>
								...
								<c:forEach var="item" items="${list}">
									<tr>
										...
										<a href="${path}/manufacturers/edit?id=${item.id}"
											...
											data-toggle="tooltip" data-original-title="Edit user">
												<img alt="Cập nhật" src="../images/icon/icon-edit.png" width="25px" height="25px"> </a>|<a href="${path}/manufacturers/delete?id=${item.id}"
