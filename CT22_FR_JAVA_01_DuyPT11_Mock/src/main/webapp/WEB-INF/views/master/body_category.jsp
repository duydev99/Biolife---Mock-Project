								...
								<c:forEach var="item" items="${list}">
									<tr>
										...
										<td class="align-middle"><a
											...
											data-toggle="tooltip" data-original-title="Edit user">
												<img alt="Cập nhật" src="../images/icon/icon-edit.png" width="25px" height="25px"> </a>|<a href="${path}/categories/delete?id=${item.id}"
											class="text-danger font-weight-bold text-xs"
											data-toggle="tooltip" data-original-title="Edit user"
											onclick="if(!(confirm('Bạn chắc chắn muốn xóa?'))) return false">
												<img alt="Xóa" src="../images/icon/icon-remove.png" width="25px" height="25px"> </a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
