				...
				<div class="col-lg-4 col-md-4 col-sm-9">
					<section class="footer-item">
						...
						<div class="footer-phone-info">
							...
							<p class="r-info">
								<span>Thắc Mắc Liên Hệ ?</span> <span>(+84) 123 123 123</span>
							</p>
						</div>
					...
					<section class="footer-item">
						...
						<div class="contact-info-block footer-layout xs-padding-top-10px">
							<ul class="contact-lines">
								<li>
									<p class="info-item">
										<i class="biolife-icon icon-location"></i> <b class="desc">600,
											đường Nguyễn Văn Cừ (nối dài), phường An Bình, quận Ninh
											Kiều, TP. Cần Thơ</b>
									</p>
								</li>
								<li>
